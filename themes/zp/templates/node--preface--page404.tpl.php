  <div class="main-content page404"> 
      ...
      <div class="content page preface">
        <?php
          ...
          drupal_set_title('Page Not Found. | За Покупками!');
          ...
          echo zp_blocks_getBlockThemed(array('module' => 'search', 'delta' => 'search-form', 'no_subject' => TRUE, 'class' => 'search-on-404', 'shadow' => FALSE)),
